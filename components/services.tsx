...
const services = [
  {
    ...
    description: "Sitios web modernos y aplicaciones escalables con las últimas tecnologías.",
  },
  {
    icon: Palette,
    title: "Diseño UI/UX",
    ...
    <section id="servicios" className="py-24 relative">
      <div className="container mx-auto px-4">
        ...
        <div className="text-center mb-16">
          <span className="text-primary text-sm font-semibold tracking-wider uppercase">Servicios</span>
          <h2 className="text-3xl md:text-4xl font-bold text-foreground mt-2 mb-4 text-balance">
            Soluciones digitales completas
          </h2>
          <p className="text-muted-foreground max-w-2xl mx-auto text-pretty">
            Ofrecemos un conjunto integral de servicios para llevar tu presencia digital al siguiente nivel.
          </p>
        </div>
